...
new WPUpdatesThemeUpdater_974( 'http://wp-updates.com/api/2/theme', basename(get_template_directory()) );
*/

if( !class_exists('WPUpdatesThemeUpdater_974') ) {
    class WPUpdatesThemeUpdater_974 {
